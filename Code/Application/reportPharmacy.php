...
class reportPharmacy extends FPDF implements report
{
    ...
    private function retrieveDataPharmacy()
    {
        $this->stat = new statistics_Query();

        return $this->stat->fetch_stat_pharmacy();
    }
    ...
    {
        $results = $this->retrieveDataPharmacy();
        $this->AddPage();
